const servicos = [
  {
    ...
    descricao:
      "Atendimento, qualificação de leads e tarefas operacionais no piloto automático.",
    icone: (
  ...
  },
  {
    ...
    descricao:
      "Ligações automatizadas com IA que fala, escuta e resolve.",
    icone: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  },
  {
    ...
    descricao:
      "Seu CRM configurado, integrado e rodando em semanas.",
    icone: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  },
  {
    ...
    descricao:
      "Dados que você entende e usa pra tomar decisão.",
    icone: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  },
  {
    titulo: "Automações",
    descricao:
      "Processos manuais eliminados. Fluxos que rodam sozinhos.",
    icone: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
...
export default function Servicos() {
  return (
    <section id="servicos" className="bg-zinc-50 py-20 sm:py-28">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-zinc-500 max-w-xl mx-auto">
            Soluções que tiram sua equipe do operacional e colocam a tecnologia
            pra trabalhar.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {servicos.map((s) => (
            ...
            >
              <div className="text-zinc-400 group-hover:text-zinc-600 transition-colors mb-4">
                {s.icone}
              </div>
